...
const resources = {
  en: {
    translation: {
      ...
      radars: {
        title: 'Vayyar Radars',
        subtitle: 'Manage radar sensors connected via MQTT',
        ...
        registerDevice: 'Link Device',
        registerDeviceTitle: 'Link MQTT Device',
        registerDeviceDesc: 'Manually link an MQTT device ID to an existing sensor',
        deviceId: 'MQTT Device ID',
        sensor: 'Target Sensor',
        selectSensor: 'Select a sensor',
        register: 'Link',
        configure: 'Configure',
        noRadars: 'No radars detected',
        noRadarsDesc: 'Vayyar radars will be automatically detected when they send data via MQTT',
        ...
        info4: 'You can manually link a device ID to an existing sensor',
        fetchError: 'Error loading radars',
        fillFields: 'Please fill in all fields',
        deviceRegistered: 'Device registered successfully',
        registerError: 'Error registering device'
      },
